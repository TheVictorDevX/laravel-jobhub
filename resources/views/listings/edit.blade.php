<x-layout>
    ...
    <x-card class="!p-10 !max-w-lg !mx-auto !mt-24">
        <header class="text-center">
            ...
            <p class="mb-4">Update your job to your liking!</p>
        </header>
        ...
        <form method="POST" action="/listings/{{ $listing->id }}" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <img class="w-48 mr-6 mb-6" src="{{ $listing->logo ? asset('/storage/'. $listing->logo) : asset('/images/noimage.svg') }}" alt="" id="logoPreview"/>
