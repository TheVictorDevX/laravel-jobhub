...
<head>
    ...
    <title>JobHub | Find Laravel Jobs & Projects</title>
</head>
...
<body class="mb-48">
    ...
    <footer
        class="fixed bottom-0 left-0 w-full flex items-center justify-start font-bold bg-laravel text-white h-24 mt-24 md:justify-center">
